...
Uint32 send_refresh_event(Uint32 interval, void *param) {
...
void video_refresh_callback(void *param) {
...
//	SDL_Rect        rect;
	...
	SDL_AddTimer(41, send_refresh_event, pCodecCtx);
	...
	for (;;) {
		...
		case FF_REFRESH_EVENT:
			video_refresh_callback(event.user.data1);
			break;
		default:
			break;
		}
